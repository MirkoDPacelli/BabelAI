...
public class BabelGA_V5 {
    ...
    public static int calculateFitness(String word) {
        int fitness = 0;
        for (String dictionaryWord : Dictionary_V5.dictionary) {
            ...
            if (match == length) {
                Main_V5.endTime = System.currentTimeMillis();
                System.out.println("\nFound real english word '" + word + "' at generation " + Main_V5.CURRENT_GENERATION + " in " + (Main_V5.endTime - Main_V5.startTime) + " ms");
                Main_V5.CONTROL = false;
            }
